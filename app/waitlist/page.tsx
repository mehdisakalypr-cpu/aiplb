// AIPLB waitlist landing — pre-launch page for Founder's Club signups (stage 5.5).
// Captures email + niche + audience size, persists to aiplb.waitlist table,
    ...
    >
      <section style={{ maxWidth: 560, margin: "0 auto", textAlign: "center" }}>
        <h1 style={{ fontSize: 44, fontWeight: 700, marginBottom: 16, lineHeight: 1.15 }}>
          Rejoins la <span style={{ color: "#C9A84C" }}>Founder&apos;s Club</span> AIPLB
        </h1>
